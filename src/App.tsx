  ...
  render(){    
    ...
    return (
      ...
      <Layout>
          ...
          <Layout className="site-layout-background" style={{ padding: '24px 0' }}>
            <Sider className="site-layout-background" width={200}>
              ...
              >
                ...
                <SubMenu key="sub3" icon={<NotificationOutlined />} title="Extra">
                  <Menu.Item key="9">
            ...
            <Content style={{ padding: '0 24px', minHeight: 280 }}>
              <Switch>
                ...
                <Route path="/profile/:userId?" render={() => <SuspenedProfile />} />
        ...
        <Footer style={{ textAlign: 'center' }}>Social Network by React and Ant Design ©2020 Created by leko13st</Footer>
      </Layout>
